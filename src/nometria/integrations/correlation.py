...
def push_verdict(
    ...
    *,
    ...
    payload_tags = [f"nometria:{verdict}"]
    if effective_verdict and effective_verdict != verdict:
        payload_tags.append(f"nometria-effective:{effective_verdict}")
    metadata = {
        "nometria_trace_id": trace_id,
        "nometria_verdict": verdict,
        "nometria_effective_verdict": effective_verdict or verdict,
        "nometria_rules": rules or [],
        "nometria_agent": agent_slug,
    }
