...
The security guardrails in :mod:`nometria.guardrails` answer "may this happen at all".
...
which is the whole architectural point. See :mod:`nometria.business.graph`.
"""
