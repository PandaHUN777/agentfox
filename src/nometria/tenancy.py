...
_SYSTEM_SCOPE: contextvars.ContextVar[bool] = contextvars.ContextVar(
    "nometria_system_scope", default=False
)
...
def assert_tenant_safe() -> list[str]:
    ...
    Called at import time by :mod:`nometria.models`. The point is that adding a model
