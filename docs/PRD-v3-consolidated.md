...
23.2k lines, 269 passing tests, offline-capable, **41% weighted coverage of 32 tracked
...
bidirectional LangSmith/Langfuse correlation, 36 controls mapped to 7 frameworks. Tranche 0 is complete: streaming, migrations, kill switch and the
...
**Snapshot — 41% weighted coverage of 32 tracked capabilities** (8 built · 10 partial ·
14 absent) · 23.2k lines · 269 passing tests · ruff clean · offline-capable (no API key,
...
The honest reading of 41% is that **the enforcement spine is real and the coverage breadth
