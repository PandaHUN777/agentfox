...
38.3k lines, 676 passing tests, offline-capable, **68% weighted coverage of 38 tracked
...
**Snapshot — 68% weighted coverage of 38 tracked capabilities** (21 built · 10 partial ·
7 absent) · **61% of the catalogued failure modes** (34 outright, 2 partial) ·
**100% injection recall** on a 35-case adversarial corpus with zero false positives ·
38.3k lines · 676 passing tests · ruff clean · offline-capable (no API key,
...
authentication ✅ **API tokens, dev header refused outside development** · rate limiting ✗ ·
KMS/Vault ✗ ·
SOC 2 Type II ✗ · pen test ✗ · DPA/DR/RTO ✗ · dashboard read-only ✗ · no operator audit log ✗.
**9 of 14 standard procurement requirements unmet** — tenancy and authentication now met.
