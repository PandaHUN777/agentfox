...
29.5k lines, 427 passing tests, offline-capable, **50% weighted coverage of 32 tracked
capabilities** and **42% of the catalogued failure modes** — computed by probe, not asserted (see [status.md](status.md), regenerated by
...
12 absent) · **42% of the catalogued failure modes** (23 outright, 2 partial) · 29.5k lines ·
427 passing tests · ruff clean · offline-capable (no API key,
...
attribution is not started. Three failure families remain the weakest: `F4` entitlement (0.5/8),
`F8` context integrity (0/7) and `F7` numeric integrity (1/7).
