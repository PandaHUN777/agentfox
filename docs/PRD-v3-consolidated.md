...
26.5k lines, 356 passing tests, offline-capable, **45% weighted coverage of 32 tracked
...
**Snapshot — 45% weighted coverage of 32 tracked capabilities** (10 built · 9 partial ·
13 absent) · 26.5k lines · 356 passing tests · ruff clean · offline-capable (no API key,
...
The honest reading of 45% is that **the enforcement spine is real and the coverage breadth
