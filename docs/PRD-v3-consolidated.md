...
37.3k lines, 658 passing tests, offline-capable, **68% weighted coverage of 36 tracked
...
**Snapshot — 68% weighted coverage of 37 tracked capabilities** (20 built · 10 partial ·
...
37.3k lines · 658 passing tests · ruff clean · offline-capable (no API key,
