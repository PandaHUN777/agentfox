...
32.3k lines, 501 passing tests, offline-capable, **66% weighted coverage of 32 tracked
...
**Snapshot — 66% weighted coverage of 32 tracked capabilities** (17 built · 8 partial ·
7 absent) · **61% of the catalogued failure modes** (34 outright, 2 partial) · 32.3k lines ·
501 passing tests · ruff clean · offline-capable (no API key,
