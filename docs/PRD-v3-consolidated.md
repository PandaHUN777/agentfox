...
36.4k lines, 636 passing tests, offline-capable, **68% weighted coverage of 36 tracked
...
**Snapshot — 68% weighted coverage of 36 tracked capabilities** (20 built · 9 partial ·
...
36.4k lines · 636 passing tests · ruff clean · offline-capable (no API key,
