...
30.8k lines, 471 passing tests, offline-capable, **50% weighted coverage of 32 tracked
capabilities** and **61% of the catalogued failure modes** — four of eight families complete
(F1, F2, F5, F7) — computed by probe, not asserted (see [status.md](status.md), regenerated by
...
**Snapshot — 50% weighted coverage of 32 tracked capabilities** (12 built · 8 partial ·
12 absent) · **61% of the catalogued failure modes** (34 outright, 2 partial) · 30.8k lines ·
471 passing tests · ruff clean · offline-capable (no API key,
...
attribution is not started. Four families are complete (F1, F2, F5, F7). The three
weakest remaining are `F4` entitlement (0.5/8), `F8` context integrity (0/7) and `F6` commitment
and liability (1.5/6).
