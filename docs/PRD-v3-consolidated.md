...
34.7k lines, 569 passing tests, offline-capable, **67% weighted coverage of 35 tracked
capabilities** and **61% of the catalogued failure modes** — four of eight families complete
(F1, F2, F5, F7), and every integration surface above 3/11 practitioner frequency — computed by probe, not asserted (see [status.md](status.md), regenerated by
...
**Snapshot — 67% weighted coverage of 35 tracked capabilities** (19 built · 9 partial ·
7 absent) · **61% of the catalogued failure modes** (34 outright, 2 partial) · 34.7k lines ·
569 passing tests · ruff clean · offline-capable (no API key,
