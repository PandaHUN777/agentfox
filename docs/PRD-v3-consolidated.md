...
25.5k lines, 315 passing tests, offline-capable, **44% weighted coverage of 32 tracked
...
governance, 36 controls mapped to 7 frameworks. Tranche 0 is complete: streaming, migrations, kill switch and the
...
**Snapshot — 44% weighted coverage of 32 tracked capabilities** (10 built · 8 partial ·
14 absent) · 25.5k lines · 315 passing tests · ruff clean · offline-capable (no API key,
...
The honest reading of 44% is that **the enforcement spine is real and the coverage breadth
