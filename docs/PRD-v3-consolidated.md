...
39.9k lines, 704 passing tests, offline-capable, **68% weighted coverage of 38 tracked
capabilities** and **75% of the catalogued failure modes** — five of eight families complete
(F1, F2, F4, F5, F7), and every integration surface above 3/11 practitioner frequency — computed by probe, not asserted (see [status.md](status.md), regenerated by
