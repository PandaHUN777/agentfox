...
| **P6-2** Control catalog & framework mapping | ✅ 39 controls × 7 frameworks | `compliance/controls.yaml`, `compliance/catalog.py` | NOM-GOV-02 | `test_registry_and_compliance.py::test_catalog_syncs_all_controls`, `::test_review_status_survives_resync` |
