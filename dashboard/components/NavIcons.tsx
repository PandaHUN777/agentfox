...
const PATHS: Record<string, React.ReactNode> = {
  ...
  "/settings/tokens": <><circle cx="8" cy="8" r="4.5" /><path d="M11.2 10.8 20 19.6M16.5 15.1l2.3 2.3M19.1 12.5l2.4 2.4" /></>,
  ...
  "/approvals": <><path d="M9 12.5l2 2 4-4.5" /><rect x="3.5" y="3.5" width="17" height="17" rx="2.5" /></>,
